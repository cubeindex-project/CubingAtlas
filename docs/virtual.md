...
- [Rubik's Cube Simulator](https://shuantsu.itch.io/rubiks-cube-simulator) - A Rubik's Cube Simulator that can be played with keyboard or gamepad
- [IsoCubeSim](https://mzrg.com/rubik/iso/) - A cuboid (LxMxN) simulator
- [MagicCube: A NxNxN Rubik Cube implementation](https://github.com/trincaog/magiccube) / [Documentation](https://trincaog.github.io/magiccube/magiccube.html)
